...
through a unicode-surrogate scrub. **Deliberately not "fixed" here:** the scrub is
...
### PR 1 — record the served envelope id
...
### PR 2 — the witnesses join + terminal-anchored building
